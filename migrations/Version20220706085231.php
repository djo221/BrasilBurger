 ...
 */
final class Version20220706085231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_commande ADD produit_id INT DEFAULT NULL, ADD commande_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_commande DROP produit_id, DROP commande_id');
    }
}
